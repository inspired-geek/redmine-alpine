...
`bundle check` and exits immediately with a build instruction when a mounted
plugin needs a missing gem. It does not retry a dependency error as though it
were a temporarily unavailable database.
